...
def test_full_zoom_clone_backend():
    ...
    print("  ✓ Alice signup & HTTP-only cookie verified")
    ...
    print("  ✓ Bob signup & HTTP-only cookie verified")
    ...
    print(f"  ✓ Instant meeting created: {meeting_id}")
    ...
    print(f"  ✓ Bob joined meeting ID: {meeting_id} as participant ID: {p_data['id']}")
    ...
    print(f"  ✓ Scheduled meeting created: {sched_data['meeting_id']}")
    ...
    print("  ✓ Meeting state confirmed inactive")
