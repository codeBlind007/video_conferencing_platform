      ...
      <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-md p-6 sm:p-8 shadow-xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">
            Sign In to <span className="text-[#0E71EB]">Zoom</span>
          </h1>
          <p className="text-xs text-slate-500 mt-1">Welcome back! Access your meetings.</p>
        </div>
        ...
        <div className="mt-8 text-center border-t border-slate-100 pt-6">
          <p className="text-xs text-slate-500">
            ...
            <Link href="/signup" className="text-[#0E71EB] hover:underline font-bold">
              Create an account
            </Link>
          </p>
        </div>
